        ...
        {stats && (
          <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
              <div className="bg-white rounded-xl shadow-lg p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Services par Type</h3>
                <div className="space-y-3">
                  {stats.servicesByType.slice(0, 5).map((item) => (
                      ...
                      <div className="flex items-center space-x-2">
                        <div className="w-32 bg-gray-200 rounded-full h-2">
                          <div
                            ...
                            style={{ width: `${(item.count / stats.overview.totalServices) * 100}%` }}
                          ></div>
                        </div>
              ...
              <div className="bg-white rounded-xl shadow-lg p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Top Marques</h3>
                <div className="space-y-3">
                  {stats.vehiclesByBrand.slice(0, 5).map((item) => (
                    <div key={item._id} className="flex items-center justify-between">
                      <span className="text-gray-700">{item._id}</span>
                      <div className="flex items-center space-x-2">
                        <div className="w-32 bg-gray-200 rounded-full h-2">
                          <div
                            ...
                            style={{ width: `${(item.count / stats.overview.totalVehicles) * 100}%` }}
                          ></div>
                        </div>
                        <span className="text-sm font-medium text-gray-900 w-8">{item.count}</span>
                      </div>
